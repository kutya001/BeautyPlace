...
export function getSalonPrice(salonId, serviceId, servicesList) {
...
export const ThemeManager = {
  setTheme: (themeName) => {
    const validThemes = ['beauty', 'barber', 'hair', 'eco', 'medical'];
  ...
  toggleTheme: () => {
    const themes = ['beauty', 'barber', 'hair', 'eco', 'medical'];
