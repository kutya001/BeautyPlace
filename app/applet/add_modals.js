...
// Now update layout.js
let layout = fs.readFileSync('js/apps/client/layout.js', 'utf8');
...
// Make sure we replace it globally if required, but one replace should do it

fs.writeFileSync('js/apps/client/layout.js', layout, 'utf8');
