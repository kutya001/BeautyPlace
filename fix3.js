...
const sIdx = fileContent.indexOf('export function renderBookingStep1() {');
const eIdx = fileContent.indexOf('export function renderBookingStep2() {');

const newFunc = `export function renderBookingStep1() {
...
const finalContent = fileContent.substring(0, sIdx) + newFunc + fileContent.substring(eIdx);
